...
client.on("message", async message => {
  ...
  const kobs = await db.fetch(`reklam_${message.guild.id}`)
        ...
        if (!message.member.permissions.has('KICK_MEMBERS')) {
          ...
          if (sayı == null) {
            const sa = new Discord.MessageEmbed()
                    .setColor("#07d2ff")
                    .setThumbnail("https://cdn.discordapp.com/attachments/589459197079322642/795266525916823592/F-XFX_PP_edit.jpg")
.setAuthor("F-XFX's | PRO","https://cdn.discordapp.com/attachments/589459197079322642/795266525916823592/F-XFX_PP_edit.jpg")
  .setFooter(`Komutu Kullanan | F-XFX's | PRO` ,"https://cdn.discordapp.com/attachments/589459197079322642/795266525916823592/F-XFX_PP_edit.jpg")
                    .setDescription(`
**━━━━━━━━━━━━━━━━━━━━**
**❗️ Bu Sunucuda Reklam Engel Sistemi Var. 
Devam Edersen Susturulacaksın! | \`1 / 3\` |
${msg.author}**
**━━━━━━━━━━━━━━━━━━━━**
・ ・ ・ **[Discord](https://discord.gg/rBrpWQM) | [YouTube](https://www.youtube.com/furkyy) | [Botu Ekle](https://nolur.com/)** ・ ・ ・
**━━━━━━━━━━━━━━━━━━━━**`)     
...
**━━━━━━━━━━━━━━━━━━━━**
**❗️ Bu Sunucuda Reklam Engel Sistemi Var. 
Devam Edersen Susturulacaksın! | \`2 / 3\` |
${msg.author}**
**━━━━━━━━━━━━━━━━━━━━**
・ ・ ・ **[Discord](https://discord.gg/rBrpWQM) | [YouTube](https://www.youtube.com/furkyy) | [Botu Ekle](https://nolur.com/)** ・ ・ ・
**━━━━━━━━━━━━━━━━━━━━**`)    
            ...
            if (sayı > 2) {
			msg.member.roles.add("770236476775596073");
               const sa = new Discord.MessageEmbed()
                    .setColor("#07d2ff")
                    .setThumbnail("https://cdn.discordapp.com/attachments/589459197079322642/795266525916823592/F-XFX_PP_edit.jpg")
  .setAuthor("F-XFX's | PRO","https://cdn.discordapp.com/attachments/589459197079322642/795266525916823592/F-XFX_PP_edit.jpg")
  .setFooter(`Komutu Kullanan | F-XFX's | PRO` ,"https://cdn.discordapp.com/attachments/589459197079322642/795266525916823592/F-XFX_PP_edit.jpg")
                    .setDescription(`
**━━━━━━━━━━━━━━━━━━━━**
**❗️ (\`3\`) Kere Reklam Yaptığı İçin 180 Dakika 
Boyunca Tüm Kanallarda Susturuldu! | \`3 / 3\` |
${msg.author}**
**━━━━━━━━━━━━━━━━━━━━**
・ ・ ・ **[Discord](https://discord.gg/rBrpWQM) | [YouTube](https://www.youtube.com/furkyy) | [Botu Ekle](https://nolur.com/)** ・ ・ ・
**━━━━━━━━━━━━━━━━━━━━**`)              message.channel.send(sa)
...
setTimeout(() => {
 msg.member.roles.remove("770236476775596073")
}, 1000 * 60 * 60 * 3)                 return
            }
